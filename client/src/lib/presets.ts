...
export const PRESETS: Record<string, PresetConfig> = {
  standard_bubble: {
    ...
    positivePrompt: '(masterpiece, best quality, ultra-detailed:1.2), manga style, clean lineart, (context aware inpainting:1.4), seamless texture blending, matching surrounding background, restore background pattern, highres',
